...
void editContact(AddressBook *addressBook)
{
    ...
    do
    {
        ...
        switch(choice)
        {
            case 1: index1 = search_by_name(search_term , addressBook,index_arr);
                    edit_contact(index1,addressBook);
                    break;
            case 2: index2 = search_phone(search_term , addressBook);
                    edit_contact(index2,addressBook);
                    break;
            case 3: index3 = search_email(search_term , addressBook);
                    edit_contact(index3,addressBook);
                    break;
            case 4 : break;
            default:printf("Invalid choice. Please try again.\n");
        }
...
int delete(int index1,AddressBook *addressBook)
{
    char str[10];
    int option;
    if(index1==0)
